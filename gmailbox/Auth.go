...
func Authorize() *gmail.Service {
	...
	if err != nil {
		panic(fmt.Sprintf("Unable to retrieve gmail Client %v", err))
	}
	return srv
}
...
func getClient(ctx context.Context, config *oauth2.Config) *http.Client {
	...
	if err != nil {
		panic(fmt.Sprintf("Unable to get path to cached credential file. %v", err))
	}
